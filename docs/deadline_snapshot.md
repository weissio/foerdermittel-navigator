...
- `BMBF_KMU_INNOVATIV_DIGITALE_THERAPIEKONTEXT_STEUERUNG` | KMU-innovativ - Digitale Therapiekontext-Steuerung und adaptive Versorgungskaskaden
...
- `BMDV_KSNI_INFRASTRUKTUR` | KsNI - Lade- und Tankinfrastruktur fuer klimafreundliche Nutzfahrzeuge
...
- `BMWK_IPCEI_HY2TECH` | IPCEI Wasserstoff - Hy2Tech (Technologiekomponenten)
- `BMWK_IPCEI_HY2USE` | IPCEI Wasserstoff - Hy2Use (Industrielle Anwendung und Infrastruktur)
