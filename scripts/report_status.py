...
def main() -> int:
    ...
    lines.append("- `scripts/report_link_structure.py`: aktualisiert `docs/link_structure_snapshot.md`")
    lines.append("- `scripts/report_url_sanity.py`: aktualisiert `docs/url_sanity_snapshot.md`")
    ...
    lines.append("- `scripts/report_live_link_health.py`: aktualisiert `docs/live_link_health_snapshot.md` (bei Lauf)")
    lines.append("- `scripts/check_changed_links_gate.py`: aktualisiert `docs/changed_link_health_snapshot.md` (bei Lauf)")
    ...
    lines.append("  - `docs/link_structure_snapshot.md`")
    lines.append("  - `docs/url_sanity_snapshot.md`")
    lines.append("  - `docs/master_coverage.md`")
    lines.append("  - `docs/info_link_overlap.md`")
    lines.append("  - `docs/live_link_health_snapshot.md` (optional via `make links_live`)")
    lines.append("  - `docs/changed_link_health_snapshot.md` (optional via `make gate_changed`)")
    lines.append("")
    ...
    lines.append("- `make links_live` -> Live-Link-Check (gesamt)")
    lines.append("- `make gate_changed` -> Link-Gate nur fuer geaenderte Datensaetze")
    lines.append("")
